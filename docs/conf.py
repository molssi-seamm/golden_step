...
# -*- coding: utf-8 -*-
#
# golden_step documentation build configuration file,
...
project = u'SEAMM Golden Plug-in'
...
version = golden_step.__version__
# The full version, including alpha/beta/rc tags.
release = golden_step.__version__
...
htmlhelp_basename = 'golden_stepdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'golden_step.tex',
     u'Golden Step Documentation',
     u'Paul Saxe', 'manual'),
]
